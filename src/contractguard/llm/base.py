...
class FakeProvider:
    ...
    test can stage a sequence of clause answers (e.g. a grounded response, then
    a follow-up) and assert how the review pipeline consumes them. With no
    script, echoes the first prompt line so retrieval wiring stays inspectable.
    """
